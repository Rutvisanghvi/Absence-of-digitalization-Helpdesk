<?php
	...
	else if(isset($_POST['login']))
	{
		...
		$show = "SELECT * FROM employee WHERE em_contact='$id' and em_psw='$psw'";
...
<html lang="en">
<head>
    <title>Help-desk Employee Login</title>
...
<body>
    ...
    <form name="admin" method="post" action="">
        ...
        <input type="number" maxlength="10" name="id" placeholder="contact"  />

        <label for="password">Password</label>
        <input type="password" name="psw" placeholder="Password" />

        <input type="submit" id="btn" name="login" Value="Login" />
		<input type="submit" id="btn" name="Forgotp" Value="Forgot password" />
    </form>
</body>
</html>
<!-- partial -->
