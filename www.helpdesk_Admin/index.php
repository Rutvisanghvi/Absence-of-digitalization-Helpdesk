<?php
	...
	else if(isset($_POST['login']))
	{
		...
		$show = "SELECT * FROM admin WHERE ad_id='$id' and ad_pswd='$psw'";
...
<html lang="en">
<head>
    <title>Help-desk Admin Login</title>
...
<body>
    ...
    <form name="admin" method="post" action="">
		...
		<input type="submit" id="btn" name="sign-up" Value="Sign-up" />
    </form>
</body>
</html>
<!-- partial -->
